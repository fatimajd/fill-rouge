    ...
    <div class="content">
            ...
            <div class="contact">
                        ...
                        <div class="other">
                                ...
                                <div class="svg-wrap">
                                    <a href="mailto:connor@connorgaunt.com">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.211 485.211">
                                            ...
                                            connor@connorgaunt.com</a> </div>
                                <h3>Connect</h3>
                                <div class="svg-wrap"> <a href="http://instagram.com/connorgaunt" target="_blank">
                            ...
                            <div class="form">
                                <h1>Get In Touch</h1>
                                <form action="http://localhost/FileRouge/FileRouge/Contact/save" method="post">
                                    <div class="flex-rev">
                                    ...
                                    <div class="flex-rev"> 
                                        <input placeholder="I have an idea for a project...." name="message" >
                                    </div>
